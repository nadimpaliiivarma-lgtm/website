      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center">
        ...
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-12 leading-relaxed">
            Book your appointment or contact us for consultations and complete dental care services with Dr. Nadimpaliii Varma, MDS.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center flex-wrap">
            ...
            <Button
              ...
              onClick={() =>
                window.location.href = 'mailto:nadimpaliiivarma@gmail.com'
              }
