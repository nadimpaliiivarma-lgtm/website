          ...
          <div className="container mx-auto px-4 md:px-6 text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 text-left">
                ...
                <p className="text-gray-600 mt-4">
                  Completed MDS in Department of Orthodontics & Dentofacial Orthopaedics in 2018, Sri Hasanamba Dental College & hospital, karnataka.
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 text-left">
                ...
                <p className="text-gray-600 mt-4">
                  ...
                  dentures and implant-supported restorations. Studied in St Joseph Dental College & Hospital and completed his BDS(2010) & MDS(2015) Experienced academician and researcher.
                </p>
              </div>
